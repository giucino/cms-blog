...
export class ModalService {
  ...
  private iconConfigs: { [key: string]: Omit<ModalConfig, 'message' | 'buttonText'> } = {
    created: {
      iconConfig: {
        path: '<path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>',
        class: 'w-8 h-8 text-green-500 dark:text-green-400',
        backgroundClass: 'w-12 h-12 rounded-full bg-green-100 dark:bg-green-900 p-2 flex items-center justify-center mx-auto mb-3.5',
        ariaHidden: 'true',
        fill: 'currentColor',
        viewBox: '0 0 20 20',
        xmlns: 'http://www.w3.org/2000/svg'
      },
      messageClass: 'mb-4 text-lg font-semibold text-gray-900 dark:text-white',
      buttonClass: 'bg-primary-600 hover:bg-primary-700 focus:ring-primary-300 dark:focus:ring-primary-900',
      state: 'created',
      srOnlyText: 'Erfolg'
    },
    updated: {
    ...
    deleted: {
      iconConfig: {
        path: '<path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path>',
        class: 'w-8 h-8 text-red-500 dark:text-red-400',
        backgroundClass: 'w-12 h-12 rounded-full bg-red-100 dark:bg-red-900 p-2 flex items-center justify-center mx-auto mb-3.5',
        ariaHidden: 'true',
        fill: 'currentColor',
        viewBox: '0 0 20 20',
        xmlns: 'http://www.w3.org/2000/svg'
      ...
      messageClass: 'mb-4 text-lg font-semibold text-gray-900 dark:text-white',
      buttonClass: 'bg-red-600 hover:bg-red-700 focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800',
      state: 'deleted',
      srOnlyText: 'Löschen'
    },
    error: {
      iconConfig: {
        path: '<path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>',
        class: 'w-8 h-8 text-yellow-500 dark:text-yellow-400',
        backgroundClass: 'w-12 h-12 rounded-full bg-yellow-100 dark:bg-yellow-900 p-2 flex items-center justify-center mx-auto mb-3.5',
        ariaHidden: 'true',
        fill: 'currentColor',
        viewBox: '0 0 20 20',
        xmlns: 'http://www.w3.org/2000/svg'
      ...
      messageClass: 'mb-4 text-lg font-semibold text-gray-900 dark:text-white',
      buttonClass: 'bg-yellow-600 hover:bg-yellow-700 focus:ring-yellow-300 dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-800',
      state: 'error',
      srOnlyText: 'Fehler'
    }
  };
  ...
  show(message: string, state: 'created' | 'updated' | 'deleted' | 'error') {
    ...
    const baseConfig = this.iconConfigs[state];
    ...
    const config: ModalConfig = {
      ...
      iconConfig: {
        ...
        path: baseConfig.iconConfig && baseConfig.iconConfig.path
          ? this.sanitizer.bypassSecurityTrustHtml(baseConfig.iconConfig.path as string)
